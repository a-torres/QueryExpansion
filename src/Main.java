...
public class Main {
    public static void main(String[] args) {
        ...
        String file = "C:\\Users\\Guillermo Alienware.MININT-0BI6O0J\\Desktop\\QueryExpansion\\words.txt";
        ...
        try {
            DataOutputStream out = new 
                    ...
                    FileOutputStream("C:\\Users\\Guillermo Alienware.MININT-0BI6O0J\\Desktop\\QueryExpansion\\out.txt"));
            ...
            while((temp = in.readLine()) != null){
                ...
                for(int i = 0; i < syn.length; i++)
                {
                    ...
                    System.out.println("Retrieved definition: ");
                        ...
                        System.out.println(    syn[i].getDerivationallyRelatedForms("clean").length);
                            for ( int j =0;j <  syn[i].getDerivationallyRelatedForms("clean").length;j++)
                            System.out.println("---"+(syn[i].getDerivationallyRelatedForms("clean"))[j]);
